...
use TTHQ\WPEC\Lib\PayPal\PayPal_Main;
...
class PayPal_PPCP_Onboarding {
	...
	public function output_sandbox_onboarding_link_code() {
		...
		?>
		<script>
			function wpec_ppcp_onboarded_callback_sandbox(authCode, sharedId) {
				console.log('WPEC PayPal Sandbox Onboarded-Callback');
	...
	public function output_production_onboarding_link_code() {
		...
		?>
		<script>
			function wpec_ppcp_onboarded_callback_production(authCode, sharedId) {
				console.log('WPEC PayPal Production Onboarded-Callback');
				//Send the authCode and sharedId to your server and do the next steps.
				//You can use the sellerNonce to identify the user.				
