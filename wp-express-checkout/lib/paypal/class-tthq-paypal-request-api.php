...
class PayPal_Request_API {
	...
	public $app_info = array(
		...
		'url' => 'https://wordpress.org/plugins/wp-express-checkout/',
	);
	...
	public static function get_paypal_auth_assertion_value($environment_mode){
		...
		$pp_auth_assertion = base64_encode( json_encode( $jwt_header_data ) ) . 'paypal-client' . base64_encode(json_encode($jwt_payload)) . '.';//The signature is empty
