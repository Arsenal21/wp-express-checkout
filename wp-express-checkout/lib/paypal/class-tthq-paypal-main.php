...
namespace TTHQ\WPEC\Lib\PayPal;

use TTHQ\WPEC\Lib\PayPal\Onboarding\PayPal_PPCP_Onboarding_Serverside;

////Includes
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-config.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-request-api.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-request-api-injector.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-js-button-embed.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-subsc-billing-plan.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-webhook.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-webhook-event-handler.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-onapprove-ipn-handler.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-utility-functions.php' );//Misc project specific utility functions.
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-utility-ipn-related.php' );//Misc IPN related utility functions.
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-cache.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-bearer.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-button-ajax-handler.php' );
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-acdc-related.php' );

////Onboarding related includes
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/onboarding-related/class-tthq-paypal-onboarding.php' );//PPCP Onboarding related functions.
//include_once( WPEC_PLUGIN_PATH . 'lib/paypal/onboarding-related/class-tthq-paypal-onboarding-serverside.php' );//PPCP Onboarding serverside helper.
...
class PayPal_Main {
    ...
    public function __construct( $conf ) {
		...
		if ( empty(get_option( $conf['enable_sandbox_settings_key'] )) ) {
